(function() {
    ...
    function insertTextAndSend(hauptkeyword, keyword, nebenkeywords, proofkeywords, w_fragen, outlineText = false) {
        ...
        let text;
        if (outlineText) {
            text = `Du bist in der Rolle eines Werbetexters mit tiefem Verständnis für die Suchmaschinenoptimierung. Ich will, dass du mir für folgendes Keyword bzw. Thema einen Text nach meinen Vorgaben und basierend auf den hochgeladenen Beispieltexten generierst.

                    Keyword: "${hauptkeyword}"

                    Der Text soll ein Kaufberatertext auf einer Produktlistenseite unterhalb der Produkte sein. Er soll SEO-optimiert und leicht lesbar sein und die Produktlistenseite für Google für das Keyword bzw. Thema optimieren. Der Text soll sich dem Sprachjargon unserer Kundin anpassen, positiv geschrieben sein und Emotionalität vermitteln.
                    Wenn du die Leser/in direkt ansprichst, dann mit "Sie".
                    Der Text soll eher informell geschrieben sein, mit Fokus auf den Kundennutzen und die Kundin zu dem Thema beraten.
                    In den Überschriften soll auch ein Keyword bzw. Themenfokus bestehen. Schreibe die Überschriften interessant, informativ und stelle den Kundennutzen hervor.
                    Du sollst mir bereits im Text wichtige Wörter für den Lesefluss fett markieren (in **Fettschrift**). Beschränke dich mit den Fettungen auf maximal drei wichtige Wörter. Wichtige Wörter sind z.B. Eigenschaften, Merkmale oder Produktkategorien.
                    Schreibe im Text nichts über folgende Themen: Nachhaltigkeit, Pelz, Kundenmeinung, Zahlungsmöglichkeiten, Marken.
                    Thematisch dreht sich der Text um eine Produktkategorie aus dem Modesegment. Der Text sollen demnach für verschiedene Fragestellung zu dem Thema beraten, welche dem Leser vor einem Kauf helfen können. Hilfreiche Bereiche sind zum Beispiel:
                    Kombinationsmöglichkeiten, Materialkunde und -vorteile, Größenberatung, Passformberatung, Stilberatung für verschiedene Anlässe, saisonale Trends und zeitlose Klassiker, Pflege- und Aufbewahrungstipps, Komfort, Farb- und Musterberatung, Accessoires und Ergänzungen, Körper- und Figurtypberatung.
                    Halte dich im Text an folgende Gliederung:
                    "${keyword}"
                    Wenn noch weitere Punkte zu dem Thema relevant sind, dann ergänze sie. Du sollst dich aber nur daran orientieren. Wenn aus deiner Sicht ein anderes Thema bezogen auf das Keyword "${hauptkeyword}" besser ist, dann schreibe darüber. Wichtig ist, dass der Leser mit dem Text eine bessere Kaufentscheidung treffen kann, weil er sich genau mit diesem Thema nach dem Lesen deines Textes besser auskennt und weiß, worauf er beim Kauf achten sollte.
                    Um die SEO-Relevanz zu steigern, verwende im Text auch die Nebenkeywords: "${nebenkeywords}".
                    Stelle die Nebenkeywords bei Bedarf im Text so um, dass ein grammatikalisch korrekter Satz entsteht. Verwende sie so, dass es sich nach einem natürlichen Sprachgebrauch anhört.
                    Die folgenden Proof-Keywords können auch eingebaut werden, um die thematische Relevanz zu steigern "${proofkeywords}".
                    Versuche das, so gut es geht. Wirkt der Text dadurch zu unnatürlich, dann lasse einzelne dieser Wörter weg.
                    ...
                    Achte auf eine gute Readability. Nutze dafür auch Stilelemente wie zum Beispiel Stichpunkte, Aufzählungen in den einzelnen Absätzen.`;
        } else {
            text = `Du bist ein erfahrener SEO- und Copywriting-Experte mit umfassendem Wissen über die Bedürfnisse von Kundinnen im Bereich Damenmode und Damenunterwäsche. Erstelle eine strukturierte Gliederung zum Thema "${hauptkeyword}" für eine Produktlistenseite eines Online-Shops.
                            Ziel: Die Gliederung soll potenziellen Kundinnen wertvolle Informationen bieten, häufig gestellte Fragen zu dem Produkt beantworten und unterstützende Informationen bereitstellen, die eine Kaufentscheidung ermöglichen.
                            ...
                            •	Strukturiere die Themen bereits als ausführliche Überschriften. Schreibe die Überschriften interessant, informativ und kreativ Integriere in die Überschriften geschickt Keywords. Stelle die Keywords so um, dass in jedem Fall ein grammatikalisch korrekter Satz entsteht. Verwende sie so, dass es sich nach einem natürlichen Sprachgebrauch anhört.
                            •	Wenn du die Leser/in direkt ansprichst, dann mit "Sie".
