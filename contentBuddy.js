(function() {
    ...
    function extractOutline() {
        ...
        const elements = document.querySelectorAll('div[data-v-1b20217d].v-col-md-10.v-col-12.px-0.pt-0.content');
        console.log(`Gefundene Elemente data-v-3897b197: ${elements.length}`);
