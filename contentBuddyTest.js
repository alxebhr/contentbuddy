...
Leider funktioniert der Code nicht wie gewünscht. Bei den einzelnen SChritten werden teilweise die falschen Prompts gefeuert. Ich möchte, dass du das Skript so anpasst, dass die richtigen Prompts gefeuert werden. Die Prompts sind in den verlinkten Dateien für Witt, heine und Sieh an gespeichert. die Prompts sollen nach folgender Logik gefeuert werden: 

- Gliederungs-Generierung A-Text: window.promptTextDefault

- Text-Generierung A-Text: window.promptTextOutline

- Text-Generierung B-Text: window.promptBText



Schaue hierfür insbesondere auf diesen Code-Abschnitt: 
