    ...
    generateATextButton.addEventListener('click', () => {
      ...
      if (outline) {
        ...
        if (container) {
          ...
          // Erstelle den Button "finalen Text generieren"
          ...
          generateFinalTextButton.addEventListener('click', () => {
            ...
            insertTextAndSend(mainkeyword, mainkeyword, subkeywords, proofkeywords, w_fragen, true);
            console.log('Finaler Text wurde generiert:', mainkeyword, subkeywords, proofkeywords, w_fragen);
          });
