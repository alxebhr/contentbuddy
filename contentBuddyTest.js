(function() {
  ...
  function createOutlineBoxes(outline, container) {
    ...
    generateTextButton.addEventListener('click', () => {
      ...
      insertTextAndSend(mainkeyword, outlineText, subkeywords, proofkeywords, w_fragen, false); // Für Text-Generierung
  ...
  function createOverlay(button) {
    ...
    insertButton.addEventListener('click', () => {
      ...
      if (hauptkeyword) {
        insertTextAndSend(hauptkeyword, hauptkeyword, nebenkeywords, proofkeywords, w_fragen, true); // Für Gliederungs-Generierung
