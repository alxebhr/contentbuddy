...
      const textType = document.querySelector('select').value; 
      if (textType === 'A') {
         // Generiere Text für Typ A
         const outlineText = generateOutlineText(mainkeyword, subkeywords, proofkeywords, w_fragen, outlinePoints);
...
        if (textType === 'A') {
          // Generiere Text für Typ A
          const outlineText = generateOutlineText(hauptkeyword, nebenkeywords, proofkeywords, w_fragen, ""); // Hier wird die Gliederung übergeben
...
  function generateOutlineText(hauptkeyword, nebenkeywords, proofkeywords, w_fragen, outlineText) {
...
      .replace(/\$\{outline\}/g, outlineText); // Hier die Gliederung hinzufügen
  }
