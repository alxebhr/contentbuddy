(function() {
    ...
    function insertTextAndSend(hauptkeyword, keyword, nebenkeywords, proofkeywords, w_fragen, outlineText = false) {
        ...
        // Hier die Logik für die Textauswahl anpassen
        const textType = outlineText ? 'A' : 'B'; // Beispiel, hier könnte eine andere Logik stehen
    ...
    function createOverlay(button) {
        ...
        insertButton.addEventListener('click', () => {
            ...
            if (hauptkeyword) {
                if (textType === 'A') {
                    insertTextAndSend(hauptkeyword, hauptkeyword, nebenkeywords, proofkeywords, w_fragen, true); // Gliederungs-Generierung A-Text
                    ...
                    const text = window.promptBText
                        ...
                        .replace(/\$\{proofkeywords\}/g, proofkeywords)
                        .replace(/\$\{w_fragen\}/g, w_fragen);
                    insertTextAndSend(hauptkeyword, text, nebenkeywords, proofkeywords, w_fragen, false); // Text-Generierung B-Text
