...
    };
    button.onclick = () => {
      const hauptkeyword = prompt('Haupt-Keyword eingeben:').trim();
      const nebenkeywords = prompt('Neben-Keywords eingeben:').trim();
      const proofkeywords = prompt('Proof-Keywords eingeben:').trim();
